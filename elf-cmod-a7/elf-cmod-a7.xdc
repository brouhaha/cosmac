...
set_property -dict { PACKAGE_PIN L1  IOSTANDARD LVCMOS33 PULLUP true } [get_ports {sw_d[3]}]
...
set_property -dict { PACKAGE_PIN N2  IOSTANDARD LVCMOS33 } [get_ports uart_cts_n]
